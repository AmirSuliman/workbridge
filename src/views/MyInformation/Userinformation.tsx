      ...
      <TabsContainer containerClasses="my-1 pb-2 md:pb-4">
        <div className="flex gap-0  my-2 border-b-[1px] border-gray-border overflow-x-auto ">
          <TabButton
            ...
            href={`${
              empId
                ? `/user/employees/employee-info/${empId}?tab=0`
                : '/user/my-information?tab=0'
            }`}
          />
          <TabButton
            name="Employment"
            href={`${
              empId
                ? `/user/employees/employee-info/${empId}?tab=1`
                : '/user/my-information?tab=1'
            }`}
          />
          ...
          {!editEmployee && (
            <>
              <TabButton
                ...
                href={`${
                  empId
                    ? `/user/employees/employee-info/${empId}?tab=2`
                    : '/user/my-information?tab=2'
                }`}
              />
              <TabButton
                name="Documents"
                href={`${
                  empId
                    ? `/user/employees/employee-info/${empId}?tab=3`
                    : '/user/my-information?tab=3'
                }`}
              />
              <TabButton
                name="Emergency"
                href={`${
                  empId
                    ? `/user/employees/employee-info/${empId}?tab=4`
                    : '/user/my-information?tab=4'
                }`}
              />
              <TabButton
                name="Notes"
                href={`${
                  empId
                    ? `/user/employees/employee-info/${empId}?tab=5`
                    : '/user/my-information?tab=5'
                }`}
              />
              <TabButton
                name="Payments"
                href={`${
                  empId
                    ? `/user/employees/employee-info/${empId}?tab=6`
                    : '/user/my-information?tab=6'
                }`}
              />
            </>
          )}
