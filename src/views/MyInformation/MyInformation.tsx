        ...
        <section className={`p-4 h-full  ${inter.className}`}>
            ...
            <TabsContainer containerClasses='my-1 pb-2 md:pb-4'>
                <div className='flex gap-0  my-2 border-b-[1px] border-gray-border overflow-x-auto '>
                    <Tab index={0} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Personal</Tab>
                    <Tab index={1} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Employment</Tab>
                    <Tab index={2} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Time Off </Tab>
                    <Tab index={3} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Documents</Tab>
                    <Tab index={4} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Emergency</Tab>
                    <Tab index={5} tabStyles='text-xs px-[3%] py-3 text-dark-navy  whitespace-nowrap ' activeTabStyle='font-semibold border-b-2 !border-dark-navy'>Notes</Tab>
                </div>
                <div>
