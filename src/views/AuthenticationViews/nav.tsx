            ...
            <div className="hidden md:flex gap-12">
                <Link
                    ...
                    className={`text-[#0F172A] hover:text-black hover:text-black  ${
                        isActive('/') ? 'font-bold text-black underline underline-offset-8' : ''
                    }`}
                >
                    Home
                </Link>
                <Link
                    href="/Features"
                    className={`text-[#0F172A] hover:text-black hover:text-black ${
                        isActive('/Features') ? 'font-bold text-black underline underline-offset-8' : ''
                    }`}
                >
                    Features
                </Link>
                <Link
                    href="/Get-started"
                    className={`text-[#0F172A] hover:text-black hover:text-black ${
                        isActive('/Get-started') ? 'font-bold text-black underline underline-offset-8' : ''
                    }`}
                >
                    Get started
                </Link>
                <Link
                    ...
                    className={`text-[#0F172A] hover:text-gray-600 ${
                        isActive('/FAQ') ? 'font-bold text-black underline underline-offset-8' : ''
                    }`}
                ...
                <Link
                    href="/Aboutus"
                    className={`text-[#0F172A] hover:text-black hover:text-black  ${
                        isActive('/Aboutus') ? 'font-bold text-black underline underline-offset-8' : ''
                    }`}
                >
                    About us
                </Link>
            ...
            <Link href="/Demo">
                <div className="hidden md:block">
                    <button className="flex flex-row items-center gap-1 bg-[#0F172A] p-3 text-white rounded-lg text-[12px]">
                        Try our<span className='font-bold'>Demo</span> <MoveUpRight size={14} />
                    </button>
                </div>
            </Link>
            ...
            {isOpen && (
                <div className="absolute top-12 left-0 w-full bg-white shadow-lg flex flex-col items-center py-4 md:hidden">
                    ...
                    <Link
                        href="/Get-started"
                        className={`text-[#0F172A] py-2 hover:text-gray-600 ${
                            isActive('/GetStarted') ? 'font-bold text-black underline underline-offset-8' : ''
                        }`}
                        onClick={handleToggle}
                    >
                        Get started
                ...
                >
                    ...
                    <Link
                        href="/Contact"
                        className={`text-[#0F172A] py-2 hover:text-gray-600 ${
                            isActive('/Contact') ? 'font-bold text-black underline underline-offset-8' : ''
                        }`}
                        onClick={handleToggle}
                    >
                        Contact
