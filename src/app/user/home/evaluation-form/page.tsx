  ...
  return (
    <div className="p-6 w-full">
      <div className="flex flex-row items-center justify-between w-full">
        ...
        <button className="border p-2 rounded bg-white px-4 text-[12px]">
          Cancel
        </button>
      </div>
      ...
      <div className="bg-white p-6 mt-5 rounded-[10px] border w-full">
        ...
        <div className="flex flex-row items-center justify-end mt-32 gap-4">
          <button className="text-[14px] p-2 border rounded px-4 bg-white">
            Skip
          </button>
          <button className="text-[14px] p-2 border rounded px-4 bg-black text-white">
            Next Question
          </button>
        </div>
      </div>
