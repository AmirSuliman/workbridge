      ...
      <form onSubmit={onSubmit}>
        ...
        <div>
          <div className='bg-white rounded-lg border'>
            ...
            <div className='w-full h-[0.7px] bg-gray-200 ' />
            <div className='p-8'>
              <div className='flex flex-row items-center gap-2 text-[#0F172A] text-[18px] font-medium mb-4'>
                <svg
                  width='16'
                  height='17'
                  viewBox='0 0 16 17'
              ...
              {questions.map((q, index) => (
                <div
                  key={index}
                  className='flex flex-wrap sm:flex-nowrap mt-4 gap-2 items-center'
                >
                  ...
                  <button
                    ...
                    className={`w-10 h-6 sm:mt-4 flex-grow-0 shrink-0 flex items-center rounded-full p-1 cursor-pointer transition-colors ${
                      q.required ? 'bg-dark-navy' : 'bg-gray-300'
                    }`}
                  >
                    <div
                  ...
                  <span className='text-gray-700 sm:mt-4 text-sm'>
                    Required
                  </span>
                  ...
                  <button
                    ...
                    className='form-error hover:text-red-700 p-2 sm:mt-4'
                  >
                    <Image
                      loader={imageLoader}
                      src='/delete.svg'
              ...
              <div className='flex flex-wrap sm:flex-nowrap mt-4 gap-2 items-center w-full'>
                <label className='flex flex-col w-full'>
                  <span className='form-label'>Question Title</span>
                  <input
                ...
                <button
                  ...
                  className={`w-10 h-6 sm:mt-4 flex-grow-0 shrink-0 flex items-center rounded-full p-1 cursor-pointer transition-colors ${
                    isRequired ? 'bg-dark-navy' : 'bg-gray-300'
                  }`}
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transform transition-transform ${
                ...
                <span className='text-gray-700 text-sm sm:mt-4'>Required</span>

                <button
                  type='button'
                  className='text-[14px] sm:mt-4 bg-[#0F172A] text-white w-full max-w-fit rounded-lg p-2 px-4'
