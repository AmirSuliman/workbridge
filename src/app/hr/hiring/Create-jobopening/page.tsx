        ...
        <div>
          <div className="bg-white rounded-lg border">
            ...
            <div className="p-8">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M2.3409 0.737793C1.58416 0.737793 0.970703 1.35125 0.970703 2.10799V14.7138C0.970703 15.4705 1.58416 16.084 2.3409 16.084H11.6582C12.415 16.084 13.0284 15.4705 13.0284 14.7138V8.95897C13.0284 7.44549 11.8015 6.21858 10.288 6.21858H8.91784C8.1611 6.21858 7.54764 5.60512 7.54764 4.84838V3.47818C7.54764 1.96471 6.32073 0.737793 4.80725 0.737793H2.3409ZM3.71109 10.6032C3.71109 10.3005 3.95648 10.0551 4.25917 10.0551H9.73996C10.0427 10.0551 10.288 10.3005 10.288 10.6032C10.288 10.9059 10.0427 11.1513 9.73996 11.1513H4.25917C3.95648 11.1513 3.71109 10.9059 3.71109 10.6032ZM4.25917 12.2474C3.95648 12.2474 3.71109 12.4928 3.71109 12.7955C3.71109 13.0982 3.95648 13.3436 4.25917 13.3436H6.99956C7.30226 13.3436 7.54764 13.0982 7.54764 12.7955C7.54764 12.4928 7.30226 12.2474 6.99956 12.2474H4.25917Z" fill="#0F172A"/>
              <path d="M7.70928 0.968647C8.29154 1.64138 8.6438 2.51864 8.6438 3.47818V4.84838C8.6438 4.99973 8.76649 5.12242 8.91784 5.12242H10.288C11.2476 5.12242 12.1248 5.47468 12.7976 6.05693C12.1487 3.57309 10.1931 1.61748 7.70928 0.968647Z" fill="#0F172A"/>
              </svg>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M16 8.10645C16 12.5247 12.4183 16.1064 8 16.1064C3.58172 16.1064 0 12.5247 0 8.10645C0 3.68817 3.58172 0.106445 8 0.106445C12.4183 0.106445 16 3.68817 16 8.10645ZM14.5 8.10645C14.5 11.6963 11.5899 14.6064 8 14.6064C4.41015 14.6064 1.5 11.6963 1.5 8.10645C1.5 6.26309 2.26733 4.59895 3.5 3.41602V3.8638C3.5 4.79206 3.86875 5.6823 4.52513 6.33868L6.29289 8.10645L6 8.39934C5.60947 8.78986 5.60948 9.42303 6 9.81355L7.06066 10.8742C7.34197 11.1555 7.5 11.537 7.5 11.9349V12.2974C7.5 12.6762 7.714 13.0225 8.05278 13.1919L8.32918 13.3301C8.82316 13.577 9.42383 13.3768 9.67082 12.8828L11.1249 9.97472C11.4136 9.39724 11.3004 8.69978 10.8439 8.24324L10.0721 7.4714C9.80423 7.20357 9.40806 7.11005 9.04873 7.22982L8.66467 7.35784C8.42862 7.43653 8.17063 7.32966 8.05935 7.10711L7.76344 6.51529C7.67084 6.33009 7.70714 6.10641 7.85355 5.96C7.99997 5.81358 8.22365 5.77729 8.40885 5.86989L8.67082 6.00087C8.80968 6.0703 8.96279 6.10645 9.11803 6.10645H9.30629C9.98884 6.10645 10.4708 5.43775 10.255 4.79022L10.187 4.58622C10.1227 4.39337 10.1816 4.18078 10.3359 4.04848L11.7754 2.81465C13.4248 3.99355 14.5 5.92444 14.5 8.10645Z" fill="#0F172A"/>
</svg>
            ...
            <div className="p-8">
              ...
              {questions.map((q, index) => (
                <div key={index} className="mb-6">
                  <div className="flex flex-col items-start sm:items-center gap-1 sm:gap-8 sm:flex-row">
                    ...
                    >
                  <Image src="/delete.svg" alt='img' width={15} height={15}/>
                    </button>
                  </div>
                </div>
              ))}
              <div className="flex flex-col items-start sm:items-center gap-1 sm:gap-8 sm:flex-row">
                ...
                <div className="flex flex-row gap-3 mt-0 sm:mt-8">
                  ...
                  <button type="button" className="border p-2 px-4 text-[14px] rounded-lg">
                    Cancel
                  </button>
                </div>
              </div>
          ...
          <div onClick={handlePublish} className="w-fit p-3 px-8 h-fit mx-auto mt-4">
            <Button
              type="submit"
