       ...
       <main className="space-y-8">
          <div className="flex flex-row items-start sm:items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3">
              <button className="bg-[#0F172A] p-2 px-3 rounded-lg text-white">Save Draft</button>
              <button className="bg-white p-2 px-3 rounded-lg border" onClick={openModal} >Preview Job</button>
          ...
          <form className="bg-white rounded-lg border ">      
            ...
            <div className="flex flex-row items-center gap-2 text-[#0F172A] text-[18px] font-medium ">
             ...
             <div className="flex mt-8 flex-col sm:flex-row sm:gap-4 gap-2 items-center justify-between w-full">
               ...
               <label className="flex flex-col mb-4 sm:w-1/3 w-full">
                ...
                <select className="p-3 border rounded-lg w-full text-gray-400">
                  ...
                  <option value="marketing" className="text-gray-400">Marketing</option>
                  <option value="engineering" className="text-gray-400">Engineering</option>
                  <option value="hr" className="text-gray-400">Human Resources</option>
                  <option value="sales" className="text-gray-400">Sales</option>
                  <option value="support" className="text-gray-400">Customer Support</option>
                </select>
              </label>
              <label className="flex flex-col mb-4 sm:w-1/3 w-full">
                <span className="text-[14px] text-gray-400">Employment Type*</span>
                <select className="p-3 border rounded-lg w-full text-gray-400">
                  <option value="" className="text-gray-400">Select employment type</option>
                  <option value="marketing" className="text-gray-400">Full time</option>
                  <option value="engineering" className="text-gray-400">Part time</option>
                  <option value="hr" className="text-gray-400">Internship</option>
                </select>
              </label>
             ...
             <label className="flex flex-col mb-4 sm:w-1/3 w-full">
                ...
                <select className="p-3 border rounded-lg w-full text-gray-400">
                  <option value="" className="text-gray-400">Select hiring leads</option>
                  <option value="marketing" className="text-gray-400">lead</option>
                  <option value="engineering" className="text-gray-400">lead</option>
                  <option value="hr" className="text-gray-400">lead</option>
                  <option value="sales" className="text-gray-400">lead</option>
                  <option value="support" className="text-gray-400">lead</option>
                </select>
              </label>

              <label className="flex flex-col mb-4 sm:w-1/3 w-full">
                <span className="text-[14px] text-gray-400">Reporting Manager*</span>
                <select className="p-3 border rounded-lg w-full text-gray-400">
                  <option value="" className="text-gray-400">Select a reporting manager</option>
                  <option value="marketing" className="text-gray-400">lead</option>
                  <option value="engineering" className="text-gray-400">lead</option>
                  <option value="hr" className="text-gray-400">lead</option>
                  <option value="sales" className="text-gray-400">lead</option>
               ...
               <label className="flex flex-col mb-4 sm:w-1/3 w-full">
                 <span className="text-[14px] text-gray-400">Minimum Experience</span>
                 <input
                   type="text"
           ...
           <div className="p-8">
            ...
            <div className="p-8">
             ...
             <label className="flex flex-col mb-4 sm:w-1/3 w-full mt-8">
              <span className="text-[14px] text-gray-400 mb-2">Question Title</span>
              <input
            ...
            <button
                   ...
                   <div className="flex flex-row gap-3 mt-0 sm:mt-8">
                    <button className="text- bg-[#0F172A] text-white rounded-lg p-3 px-2">Add Question</button>
