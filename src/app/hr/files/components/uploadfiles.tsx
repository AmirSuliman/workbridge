  ...
  return (
    <div className="w-full sm:w-[700px] p-8 bg-white rounded shadow-lg relative">
      ...
      <p className="text-black text-[12px] mt-4">
        Leave blank for the file to be saved to All Files Folder
      </p>

      <div className="flex flex-row items-center w-full p-4 mt-16 gap-6 px-8">
        <button className="rounded w-full bg-[#0F172A] text-white p-4 text-center text-[14px]">
          Confirm
        </button>
        <button className="rounded w-full border  p-4 text-center text-[14px]">
          Cancel
        </button>
      </div>
    </div>
