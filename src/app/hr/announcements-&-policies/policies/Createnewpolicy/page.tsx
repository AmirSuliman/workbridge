    ...
    <div className="w-full">
      <div className="flex flex-row items-center justify-between w-full">
        ...
        <div className="flex flex-row items-center gap-2">
          <button className="text-[14px] p-2 bg-black text-white rounded">
            Save Draft
          </button>
          <button
            onClick={() =>
              (window.location.href =
                '/hr/announcements-&-policies/policies/Previewpolicy')
            }
        ...
        <form className="w-full mt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-8">
            ...
            <label className="flex flex-col gap-1 w-full">
              ...
              <select className="p-3 w-full border rounded-lg focus:outline-none focus:border-gray-300 bg-white text-gray-400">
                <option>Select a Policy Type</option>
            ...
            <label className="flex flex-col gap-1 w-full">
              ...
              <select className="p-3 w-full border rounded-lg focus:outline-none focus:border-gray-300 bg-white text-gray-400">
                <option>Sales Departments</option>
                <option value="HR">HR</option>
                <option value="IT">IT</option>
                <option value="Finance">Finance</option>
                <option value="Operations">Operations</option>
