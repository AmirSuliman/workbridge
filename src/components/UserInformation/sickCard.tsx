...
const SickCard: React.FC<ProfileCardProps> = ({
    ...
    const remainingDays = daysCount - vacationDaysUsed;
    const validRemainingDays = isNaN(remainingDays) || remainingDays < 0 ? 0 : remainingDays;
        ...
        <>
            <div className="flex items-center justify-between border border-gray-border rounded-[10px] bg-white p-3 md:p-6 md:gap-[3.3rem] max-w-[38rem] flex-1">
                ...
                <div className="flex flex-col border border-gray-border items-center justify-center rounded-[7px] h-full px-4">
                    <span className="text-lg text-dark-navy font-[400]">32</span>
    ...
    <Modal onClose={() => setIsModalOpen(false)}>
        <div className="p-6 w-[600px]">
            ...
            <div className="flex flex-row gap-4 items-center mt-4">
                ...
                <div className="text-[14px] border rounded p-3 px-12">{vacationDaysUsed} days</div>
            </div>
