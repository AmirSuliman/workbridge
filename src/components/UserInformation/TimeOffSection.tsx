...
const TimeOffSection = () => {
  const values = [
    [
      ...
      '28 August',
      '31 August',
      <span key={7} className="text-[#25A244] font-[500]">
        Approved
      </span>,
      '',
      '',
  ...
  return (
    <div className="p-1 rounded-md  h-full">
      <div className="flex flex-col md:flex-row gap-6">
        <VacationsCard
          buttonText="Request Vaction"
          title="Request Vacation"
          daysCount={32}
          icon={<UmbrellaIcon classNames="w-4 h-4 font-bold text-white" />}
          iconStyles="bg-[#00B87D]"
          subtitle="Requests need to be made at least 48 hours prior."
        />
        <VacationsCard
          buttonText="Request Sick Leave"
          title="Sick Leave Days"
          daysCount={21}
          icon={<SickPersonIcon classNames="w-4 h-4 font-bold text-white" />}
          iconStyles="bg-[#F53649]"
          subtitle=""
        />
      </div>
