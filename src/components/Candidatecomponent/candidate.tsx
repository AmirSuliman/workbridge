...
const Candidatecomponent =()=>{
    ...
    return(
       <>
       <div className='flex flex-row items-center gap-3 text-[18px] font-medium'><FaUsers/> Candidate</div>
            <div className='flex flex-col sm:flex-row items-start gap-8 mt-8'>
              <div className='p-10 rounded-full text-[45px] bg-[#F5F6FA] w-28 h-28 flex items-center justify-center text-gray-500 border'>JB</div>
