    ...
    <section className='bg-white rounded-xl border-[1px] border-[#E0E0E0] p-4 '>
      ...
      <section className=' p-4 text-[#0F172A]'>
        ...
        <div
          ...
          className='w-full overflow-auto grid divide-y-[1px] divide-[#E8E8E8] grid-cols-1 sm:grid-cols-2 gap-x-8 max-h-[400px] pr-2'
        >
          <Contact />
        </div>
      </section>
      <div className='w-full h-[1px] my-4 bg-[#E8E8E8]' />
      <div className='w-full overflow-auto grid grid-cols-1 sm:grid-cols-2 gap-x-8 max-h-[400px] pr-2'>
