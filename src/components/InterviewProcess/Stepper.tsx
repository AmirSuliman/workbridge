      ...
      <div className="flex items-center justify-between">
        <p
          className={`cursor-pointer ${
            currentStage === 'Applied' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Applied')}
        >
          First Round
        ...
        <p
          className={`cursor-pointer ${
            currentStage === 'Technical' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Technical')}
        >
          Technical Interview
        ...
        <p
          className={`cursor-pointer ${
            currentStage === 'Second' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Second')}
        >
          Second Round
        ...
        <p
          className={`cursor-pointer ${
            currentStage === 'Negotiation' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Negotiation')}
        >
        ...
        <p
          className={`cursor-pointer ${
            currentStage === 'Offer' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Offer')}
        >
          Offer Approval
        ...
        <p
          className={`cursor-pointer ${
            currentStage === 'Onboarding' ? 'font-semibold' : ''
          }`}
          onClick={() => handleNavigation('Onboarding')}
        >
          Onboarding
